...
public class BlendShapeMapper : IChannelMapper {
	public string prefix = "Facial_Blends.";
	...
	public Dictionary<string, AnimationTarget> CreateMap() {
		...
		for(int i=0; i<face.sharedMesh.blendShapeCount; i++) {
			...
			string channelName = shapeName.Replace (prefix, "Mix::")
				.Replace ("Shape", "");
		...
		if (headJoint != null) {
			...
			channelMapping.Add ("Head_Joint::Rotation_Y", 
			                    new JointTarget("Head_Joint::Rotation_Y", TransformComponent.LocalRotationY, headJoint));
			channelMapping.Add ("Head_Joint::Rotation_Z", 
			                    new JointTarget("Head_Joint::Rotation_Z", TransformComponent.LocalRotationZ, headJoint));
		...
		if (leftEye != null) {
			...
			channelMapping.Add ("Left_Eye_Joint::Rotation_Y", 
			                    new JointTarget("Left_Eye_Joint::Rotation_Y", TransformComponent.LocalRotationY, leftEye));
		...
		if (rightEye != null) {
			...
			channelMapping.Add ("Right_Eye_Joint::Rotation_Y", 
			                    new JointTarget("Right_Eye_Joint::Rotation_Y", TransformComponent.LocalRotationY, rightEye));
